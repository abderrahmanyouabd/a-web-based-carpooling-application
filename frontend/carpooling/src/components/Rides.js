...
const Rides = () => {
    ...
    // Fake ride data including profile picture and name
    const fakeRides = [
        { 
            id: 1, 
            departureTime: "17:00", 
        ...
        <div>
            ...
            <div className="container mx-auto mt-10 p-4">
                ...
                <h1 className="text-2xl font-semibold mb-4">
                    Rides from {leavingFrom} to {goingTo} on {date} for {passengers} passenger(s)
                </h1>

                <div className="overflow-auto h-[40rem] border rounded-lg shadow-md p-4">
                    {fakeRides.map((ride) => (
                        <div
                            key={ride.id}
