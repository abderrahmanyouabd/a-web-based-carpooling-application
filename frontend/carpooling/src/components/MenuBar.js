    ...
    return (
        <nav className="bg-gradient-to-r from-blue-500 to-indigo-400 p-4 shadow-lg">
            <div className="container mx-auto">
                ...
                <span
                    className={`block absolute w-full h-1 bg-white transform transition duration-300 ease-in-out ${
                                ...
                                >
                                    <div className="flex items-center">
                                        ...
                                        >
                                            <path
                                                fillRule="evenodd"
                                                d="M10 3a1 1 0 00-.71.29l-5 5a1 1 0 001.42 1.42L10 5.41l4.29 4.3a1 1 0 001.42-1.42l-5-5A1 1 0 0010 3z"
                                                clipRule="evenodd"
                                            />
                                        </svg>
                                    </div>
