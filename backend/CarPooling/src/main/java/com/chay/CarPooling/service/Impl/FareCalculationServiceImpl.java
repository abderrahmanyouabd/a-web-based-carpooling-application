...
// System.out.println("Adjusted Fuel Cost (after weather impact): " + adjustedFuelCost);
    ...
    public BigDecimal calculateFareOnxx(Trip trip) {
        ...
        double distance = 554.32; // Assuming trip has a getDistance() method
        double fuelPrice = 3.36; // Assuming trip has a getFuelPrice() method
        double fuelEfficiency = 8.0; // Assuming trip has a getFuelEfficiency() method
